...
export default function WhatsAppCardButton({ productName }: { productName: string }) {
  ...
  return (
    <button
      ...
      className="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full bg-[#25D366] text-white shadow-sm transition hover:scale-110 hover:bg-[#1ebe5d]"
    >
